...
const CTrust = (options) => {
    ...
    style.id = 'ctrust-css'
    style.innerHTML = '.ctrust{display:none;position:fixed;top:0;left:0;right:0;bottom:0;background-color:var(--ctrust-bg, rgba(40, 44, 50, 0.8));z-index:9999}.ctrust .ctrust-banner{position:fixed;bottom:1rem;right:1rem;display:grid;row-gap:2rem;background-color:var(--ctrust-banner-bg, #282c32);color:var(--ctrust-banner-fg, #ffffff);width:calc(100% - 2rem);max-width:30rem;max-height:calc(100% - 2rem);padding:1.5rem 2rem;border-radius:0.1666666667rem;overflow-y:auto}.ctrust .ctrust-banner .ctrust-intro h1,.ctrust .ctrust-banner .ctrust-intro h2,.ctrust .ctrust-banner .ctrust-intro h3,.ctrust .ctrust-banner .ctrust-intro h4,.ctrust .ctrust-banner .ctrust-intro h5,.ctrust .ctrust-banner .ctrust-intro h6{margin:0 0 1rem}.ctrust .ctrust-banner .ctrust-intro p{margin:0 0 1rem}.ctrust .ctrust-banner .ctrust-intro p:last-of-type{margin:0}.ctrust .ctrust-banner .ctrust-elements-wrapper{display:grid;row-gap:0.5rem}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element{display:grid;row-gap:0.5rem}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element .ctrust-head{display:grid;grid-template-columns:1rem 1fr 1rem;align-items:center;column-gap:1rem}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element .ctrust-head input{appearance:none;display:grid;place-content:center;margin:0;padding:0;background-color:var(--ctrust-check-bg, #ffffff);border:0.1111111111rem solid var(--ctrust-check-border, #60656c);border-radius:0.1111111111rem;width:1.5rem;height:1.5rem;cursor:pointer}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element .ctrust-head input::after{content:"";width:0.8333333333rem;height:0.8333333333rem;transform:scale(0);transition:.12s transform ease-in-out;background-color:var(--ctrust-check-checked, #43903a)}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element .ctrust-head input:checked::after{transform:scale(1)}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element .ctrust-head input:disabled{border:0.1111111111rem solid var(--ctrust-check-border, #60656c);cursor:unset}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element .ctrust-head input:disabled::after{background-color:var(--ctrust-check-disabled, #60656c)}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element .ctrust-head .ctrust-info{position:relative;width:1.2222222222rem;height:1.2222222222rem;cursor:pointer}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element .ctrust-head .ctrust-info svg{width:1.2222222222rem;height:1.2222222222rem}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element .ctrust-head .ctrust-info svg path{stroke:var(--ctrust-info-stroke, #ffffff)}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element .ctrust-description{display:none;background-color:var(--ctrust-descr-bg, #323232);color:var(--ctrust-descr-fg, #9d9d9d);padding:0.8333333333rem;font-size:0.8333333333rem;border-radius:0.1111111111rem}.ctrust .ctrust-banner .ctrust-elements-wrapper .ctrust-element .ctrust-descr-show{display:block}.ctrust .ctrust-banner .ctrust-actions{display:flex;justify-content:flex-end;align-items:center;flex-wrap:wrap;column-gap:0.5rem;row-gap:0.5rem}.ctrust .ctrust-banner .ctrust-actions .ctrust-selected{border-radius:0.1666666667rem;border:0.0555555556rem solid var(--ctrust-selectedbtn-border, #323232);padding:0.5rem 1rem;background-color:var(--ctrust-selectedbtn-bg, #43903a);color:var(--ctrust-selectedbtn-fg, #151515);cursor:pointer}@media not screen and (min-width: 768px){.ctrust .ctrust-banner .ctrust-actions .ctrust-selected{width:100%;text-align:center}}.ctrust .ctrust-banner .ctrust-actions .ctrust-all{border-radius:0.1666666667rem;border:0.0555555556rem solid var(--ctrust-allbtn-border, #323232);background-color:var(--ctrust-allbtn-bg, #ffffff);color:var(--ctrust-allbtn-fg, #000000);padding:0.5rem 1rem;cursor:pointer}@media not screen and (min-width: 768px){.ctrust .ctrust-banner .ctrust-actions .ctrust-all{width:100%;text-align:center}}.ctrust-show{display:block}.ctrust-fingerprint{position:fixed;left:0;bottom:1rem;display:flex;justify-content:center;align-items:center;padding:0.3333333333rem 0.5rem 0.3333333333rem 1rem;background-color:var(--ctrust-fingerprint-bg, #282c32);border-top-right-radius:0.1666666667rem;border-bottom-right-radius:0.1666666667rem;cursor:pointer;transition:padding .125s ease-in-out;z-index:9998}.ctrust-fingerprint:hover{padding:0.3333333333rem 0.5rem 0.3333333333rem 1.5rem}.ctrust-fingerprint:hover svg path{stroke:var(----ctrust-fingerprint-stroke-hover, #43903a)}.ctrust-fingerprint svg{width:1.3333333333rem;height:1.3333333333rem}.ctrust-fingerprint svg path{stroke:var(--ctrust-fingerprint-stroke, #ffffff)}.ctrust-wrapper{display:flex;position:relative;background-color:rgba(0,0,0,0);cursor:pointer}.ctrust-wrapper iframe,.ctrust-wrapper img,.ctrust-wrapper video,.ctrust-wrapper audio{position:relative;z-index:-1}.ctrust-wrapper::after{position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);display:flex;justify-content:center;align-items:center;width:calc(100% - 2rem);height:calc(100% - 2rem);background-color:var(--ctrust-wrapper-bg, #000000);color:var(--ctrust-wrapper-fg, #ffffff);padding:1rem;z-index:-1}.ctrust-wrapper:lang(en)::after{content:"External media has been blocked."}.ctrust-wrapper:lang(de)::after{content:"Externe Medien wurden blockiert."}'
